...
#16x16
    icon_16.path = $$(QT_INSTALL_PREFIX)/share/icons/hicolor/16x16/apps
...
#32x32
    icon_32.path = $$(QT_INSTALL_PREFIX)/share/icons/hicolor/32x32/apps
...
#48x48 #TODO: create png icon in 48x48 resolution.
    icon_48.path = $$(QT_INSTALL_PREFIX)/share/icons/hicolor/48x48/apps
...
#128x128
    icon_128.path = $$(QT_INSTALL_PREFIX)/share/icons/hicolor/128x128/apps
...
#256x256
    icon_256.path = $$(QT_INSTALL_PREFIX)/share/icons/hicolor/256x256/apps
...
#512x512
    icon_512.path = $$(QT_INSTALL_PREFIX)/share/icons/hicolor/512x512/apps
